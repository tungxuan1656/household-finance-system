...
- Frontend standards required by scope:
  ...
  - `docs/references/frontend/web/api-react-query-pattern.md` if profile hooks/query organization changes
  - `docs/references/frontend/web/zustand-store-pattern.md` if household store shape changes
