...
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Cheap / fast   | `opencode-go/deepseek-v4-flash`, `opencode-go/mimo-v2.5`, `opencode-go/minimax-m2.5`, `opencode-go/qwen3.5-plus`, `openai/gpt-5.4-mini` | `scout`, `verify-runner`, and small implementation tasks                       |
