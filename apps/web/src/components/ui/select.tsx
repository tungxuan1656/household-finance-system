...
const selectTriggerLayoutVariants = cva(
  'flex items-center justify-between gap-1.5 whitespace-nowrap *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=size-])]:size-4',
  {
    variants: {
      size: {
        sm: 'w-full',
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        ...
        selectTriggerLayoutVariants({ size }),
