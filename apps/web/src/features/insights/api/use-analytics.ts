...
type UseAnalyticsOverviewQueryOptions = { enabled?: boolean }
type UseAnalyticsComparisonQueryOptions = { enabled?: boolean }
type UseAnalyticsGroupsQueryOptions = { enabled?: boolean }
