...
import { InsightsComparisonSection } from '@/features/insights/components/insights-comparison-section'
...
function InsightsComparisonPanel({
  data,
  error,
  isLoading,
  onRetry,
...
export { InsightsComparisonPanel }
