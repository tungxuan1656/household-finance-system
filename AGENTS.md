...
This project is indexed by GitNexus as **household-finance-system** (3080 symbols, 4510 relationships, 81 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
