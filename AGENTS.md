...
This project is indexed by GitNexus as **household-finance-system** (2805 symbols, 4053 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
