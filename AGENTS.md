...
This project is indexed by GitNexus as **household-finance-system** (5509 symbols, 8220 relationships, 165 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
