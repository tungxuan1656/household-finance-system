...
This project is indexed by GitNexus as **household-finance-system** (2108 symbols, 3006 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
