...
This project is indexed by GitNexus as **household-finance-system** (1338 symbols, 1802 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
