...
This project is indexed by GitNexus as **household-finance-system** (2326 symbols, 3316 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
