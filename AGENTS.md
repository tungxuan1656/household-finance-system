...
This project is indexed by GitNexus as **household-finance-system** (2993 symbols, 4364 relationships, 71 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
