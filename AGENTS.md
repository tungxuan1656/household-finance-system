...
This project is indexed by GitNexus as **household-finance-system** (1158 symbols, 1544 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
