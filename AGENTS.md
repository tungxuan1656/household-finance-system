...
This project is indexed by GitNexus as **household-finance-system** (1296 symbols, 1752 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
