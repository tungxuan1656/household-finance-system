...
This project is indexed by GitNexus as **household-finance-system** (2060 symbols, 3028 relationships, 56 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
