...
This project is indexed by GitNexus as **household-finance-system** (4462 symbols, 6644 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
