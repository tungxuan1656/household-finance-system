...
This project is indexed by GitNexus as **household-finance-system** (2181 symbols, 3138 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
